...
@Data
@NoArgsConstructor
public class CadastroEscolaRegimeEscolarDTO {
private Long idEscolaRegimeEscolar;
    ...
    public CadastroEscolaRegimeEscolarDTO(EscolaRegimeEscolar regimeEscolar) {
    	...
    	this.periodicidadeId = regimeEscolar.getPeriodicidade().getIdPeriodicidade();
