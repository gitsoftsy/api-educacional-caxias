...
public class EscolaEsgotoController {
	...
	public ResponseEntity<List<EscolaEsgotoDTO>> buscarPorIdEscola(@PathVariable Long idEscola){
		List<EscolaEsgotoDTO> escolaEsgoto = escolaEsgotoService.buscarPorIdEscola(idEscola);
		return ResponseEntity.ok(escolaEsgoto);
	}
