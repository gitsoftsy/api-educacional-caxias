...
public class EscolaTermoColaboracaoController {
	...
	@DeleteMapping("/{idEscolaTermoColaboracao}")
	public ResponseEntity<?> excluir(@PathVariable Long idEscolaTermoColaboracao){
		service.remover(idEscolaTermoColaboracao);
