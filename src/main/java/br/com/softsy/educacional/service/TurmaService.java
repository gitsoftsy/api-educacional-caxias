...
public class TurmaService {
	...
	public List<Map<String, Object>> filtrarTurmaDisciplinas(Long idProfessor, Integer ano, Long idPeriodoLetivo,
		...
		StringBuilder sql = new StringBuilder();
		sql.append(
				"CALL PROC_FILTRAR_TURMA_DISCIPLINAS(:pIdProfessor, :pAno, :pIdPeriodoLetivo, :pIdEscola, :pIdDisciplina, :pIdTurno, :pIdCurso)");
	...
	public List<Map<String, Object>> filtrarTurmaAvaliacao(Long idEscola, Long idPeriodoLetivo, Long idTurno,
			Long idDisciplina) {
		StringBuilder sql = new StringBuilder();
	...
	public List<Map<String, Object>> listarTurmaPorPeriodoTurnoEscolaDisciSerie(Long idPeriodoLetivo, Long idSerie,
			Long idDisciplina, Long idEscola, Long idTurno) {
		StringBuilder sql = new StringBuilder();
		sql.append(
				"CALL PROC_LST_TURMA_POR_PERIODO_TURNO_ESCOLA_DISCI_SERIE(:pIdPeriodoLetivo, :pIdSerie, :pIdDisciplina, :pIdEscola, :pIdTurno)");
	...
	public List<Map<String, Object>> listarTurmaPorAnoPeriodoLetivoEscolaDisciplina(Integer ano, Long idEscola,
			Long idPeriodoLetivo, Long idDisciplina) {
		StringBuilder sql = new StringBuilder();
