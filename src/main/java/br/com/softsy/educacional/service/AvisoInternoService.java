...
//        if (dto.getDestinatarioUsuario() != null) {
...
//                avisoDestinatario.setAviso(avisoInterno);
//                avisoDestinatario.setTipoEntidade("USUARIO");
//                avisoDestinatario.setIdEntidade(usuario.getIdUsuario());
...
//        if (dto.getDestinatarioProfessor() != null) {
//            List<Professor> professores = professorRepository.findAllById(dto.getDestinatarioProfessor());
//            for (Professor professor : professores) {
//                AvisoInternoDestinatario avisoDestinatario = new AvisoInternoDestinatario();
//                avisoDestinatario.setAviso(avisoInterno);
//                avisoDestinatario.setTipoEntidade("PROFESSOR");
//                avisoDestinatario.setIdEntidade(professor.getIdProfessor());
//                avisoDestinatario.setDataCadastro(LocalDateTime.now());
//                avisoInternoDestinatarioRepository.save(avisoDestinatario);
//            }
//        }
